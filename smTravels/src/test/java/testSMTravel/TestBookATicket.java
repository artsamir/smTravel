...
//		js.executeScript("document.querySelector(\"#block-ticket-btn\").click()");  //Uncomment this final execution happend
	...
	@Test (priority = 3)
	public void testPrintTickets() throws InterruptedException {
		...
		Thread.sleep(2000);
		String pnrno = driver.findElement(By.xpath("//div[@class='alert alert-danger']/b")).getText();
